    ...
    <div className="flex-1 w-full max-w-md">
      <div className="glass-panel p-8">
        ...
        <div className="relative flex py-5 items-center">
          ...
          <span className="flex-shrink mx-4 text-zinc-500 text-xs font-mono uppercase">Or continue with</span>
          <div className="flex-grow border-t border-white/10"></div>
        </div>
        ...
        <button 
          ...
          type="button"
          className="w-full py-3.5 rounded-xl border border-white/10 hover:border-white/20 bg-white/5 hover:bg-white/10 font-bold font-space transition-all flex items-center justify-center gap-3 text-sm text-zinc-300 hover:text-white"
        >
